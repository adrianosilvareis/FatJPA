...
@NamedQueries({
    ...
    @NamedQuery(name = "SftInputAten.findByAtenNmNmaten", query = "SELECT s FROM SftInputAten s WHERE s.atenNmNmaten like :atenNmNmaten"),
    @NamedQuery(name = "SftInputAten.findByAtenUsUsaten", query = "SELECT s FROM SftInputAten s WHERE s.atenUsUsaten like :atenUsUsaten")})
public class SftInputAten implements Serializable {
    ...
    public String toString() {
        return "entidade.SftInputAten[ atenIdIdaten=" + atenIdIdaten + " ]";
    }
