...
@NamedQueries({
    ...
    @NamedQuery(name = "SftCtrlAcao.findByAcaoNmNome", query = "SELECT s FROM SftCtrlAcao s WHERE s.acaoNmNome like :acaoNmNome")})
public class SftCtrlAcao implements Serializable {
    ...
    public String toString() {
        return "entidade.SftCtrlAcao[ acaoIdIdacao=" + acaoIdIdacao + " ]";
    }
