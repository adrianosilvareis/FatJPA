...
@NamedQueries({
    ...
    @NamedQuery(name = "SftInputUnid.findByUnidNmNmunid", query = "SELECT s FROM SftInputUnid s WHERE s.unidNmNmunid like :unidNmNmunid"),
...
public class SftInputUnid implements Serializable {
    ...
    @Column(name = "unid_mt_multiplo")
    private boolean unidMtMultiplo;
    ...
    public boolean isUnidMtMultiplo() {
        return unidMtMultiplo;
    }

    public void setUnidMtMultiplo(boolean unidMtMultiplo) {
        this.unidMtMultiplo = unidMtMultiplo;
    }
    ...
    public String toString() {
        return "entidade.SftInputUnid[ unidIdIdunid=" + unidIdIdunid + " ]";
    }
