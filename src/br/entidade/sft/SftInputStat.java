...
@NamedQueries({
    ...
    @NamedQuery(name = "SftInputStat.findByStatusNmDescricao", query = "SELECT s FROM SftInputStat s WHERE s.statusNmDescricao like :statusNmDescricao")})
public class SftInputStat implements Serializable {
    ...
    public int hashCode() {
        int hash = 0;
        hash += (statusNmDescricao != null ? statusNmDescricao.hashCode() : 0);
        return hash;
    }
    ...
    public String toString() {
        return "entidade.SftInputStat[ statusIdIdstatus=" + statusIdIdstatus + " ]";
    }
