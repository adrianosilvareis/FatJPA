...
@NamedQueries({
    ...
    @NamedQuery(name = "SftInputNcon.findByNconNmNmncon", query = "SELECT s FROM SftInputNcon s WHERE s.nconNmNmncon like :nconNmNmncon")})
public class SftInputNcon implements Serializable {
    ...
    public String toString() {
        return "entidade.SftInputNcon[ nconIdIdncon=" + nconIdIdncon + " ]";
    }
